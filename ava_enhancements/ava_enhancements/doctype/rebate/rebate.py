...
# class InvalidRebate(ValidationError):
# 	pass


# class Rebate(AccountsController):
# 	def __init__(self, *args, **kwargs):
# 		super(Rebate, self).__init__(*args, **kwargs)
# 		if not self.is_new():
...
# 	def update_rebate_amounts(self):
# 		self.set_missing_ref_details(force=True)
...
# 				if not je_accounts:
# 					frappe.msgprint(_("Row #{0}: Journal Entry {1} does not have account {2} or already matched against another voucher")
...
# 		# self.add_references_gl_entries(gl_entries)
...
# 					"cost_center": self.cost_center,
# 					"bank_transaction_sequence": self.bank_transaction_sequence,
# 					"post_net_value": True
# 				}, item=self)
# 			)
# 		# if self.payment_type in ("Receive", "Internal Transfer"):
...
# 		# 			"debit_in_account_currency": self.rebate_received_amount,
# 		# 			"bank_transaction_sequence": self.bank_transaction_sequence,
# 		# 			"party_type": self.party_type,
# 		# 			"party": self.party,
# 		# 			"debit": self.rebate_received_amount,
# 		# 			"cost_center": self.cost_center
# 		# 		}, item=self)
# 		# 	)
...
# 					"account_currency": self.paid_to_account_currency,
# 					"against": self.party if self.payment_type=="Receive" else self.paid_from,
# 					"credit_in_account_currency": self.rebate_received_amount + self.tax_amount,
# 					"bank_transaction_sequence": self.bank_transaction_sequence,
# 					"party_type": self.party_type,
# 					"party": self.party,
# 					"credit": self.rebate_received_amount + self.tax_amount,
# 					"cost_center": self.cost_center
# 				}, item=self)
# 			)
...
# 				}, item=self)
# 			)
# 	# def add_references_gl_entries(self, gl_entries):
# 	# 	for d in self.get("references"):
# 	# 		if d.rebate_received_amount:
# 	# 			account_currency = get_account_currency(self.paid_to)
# 	# 			if account_currency != self.company_currency:
# 	# 				frappe.throw(_("Currency for {0} must be {1}").format(self.paid_to, self.company_currency))
...
# 	# 					"debit_in_account_currency": d.rebate_received_amount,
# 	# 					# "party_type": d.party_type,
# 	# 			        # "party": d.party,
# 	# 					"debit": d.rebate_received_amount,
# 	# 					"cost_center": self.cost_center
# 	# 				}, item=d)
# 	# 			)
...
# 					"account_currency": self.paid_to_account_currency,
# 					"against": self.party if self.payment_type=="Receive" else self.paid_from,
# 					"debit_in_account_currency": self.tax_amount,
# 					# "bank_transaction_sequence": self.bank_transaction_sequence,
...
def make_delivery_trip(source_name, target_doc=None):
	def update_stop_details(source_doc, target_doc, source_parent):
		...
		target_doc.net_total = source_parent.net_total
		target_doc.delivery_note = source_parent.name
		target_doc.posting_date = source_parent.posting_date

		# Append unique Delivery Notes in Delivery Trip
		# delivery_notes.append(target_doc.delivery_note)
		sales_invoices.append(target_doc.delivery_note)
